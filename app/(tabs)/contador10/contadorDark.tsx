  ...
  return (
    ...
    >
      ...
      <View style={styles.botoes}>
        <Button
          title="-"
          onPress={() => setContador((v) => Math.max(0, v - 1))}
        />
        <Button
          title="+"
          onPress={() => setContador((v) => Math.min(10, v + 1))}
        />
      </View>
      ...
      {(contador === 0 || contador === 10) && (
        <View style={styles.alerta}>
          {contador === 10 && (
            <Text style={styles.aviso}>Aviso: Limite máximo!</Text>
          )}
          {contador === 0 && (
            <Text style={styles.aviso}>Aviso: Limite mínimo!</Text>
          )}
        </View>
      )}
    </View>
